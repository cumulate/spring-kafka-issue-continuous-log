...
* The original package name 'com.tmt.spring-kafka-issue' is invalid and this project uses 'com.tmt.springkafkaissue' instead.
...
```
$ docker run --rm -p 8080:8080 spring-kafka-issue-continous-log:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/spring-kafka-issue-continous-log
```
